...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen py-16 px-4 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tight">
            hi saif here <span className="text-yellow-400 inline-block">👋</span>
          </h1>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <button className="bg-black text-white dark:bg-white dark:text-black px-6 py-3 rounded-md font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors">
            Ask me anything
          </button>
        </motion.div>
